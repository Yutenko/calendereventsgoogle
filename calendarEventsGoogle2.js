...
class ATimeliner {
  constructor () {
    this.calendarId = 'd9bh37cbe4acdas97dh1k1igt0@group.calendar.google.com'
 ...
 async init () {
  ...
  const loadStyle = new ScriptLoader({ src: 'https://destrudo.de/calendareventsgoogle/style.css', global: 'Segment' })
